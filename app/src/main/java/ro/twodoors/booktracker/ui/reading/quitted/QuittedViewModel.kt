package ro.twodoors.booktracker.ui.reading.quitted
...
class QuittedViewModel(application: Application) : ViewModel() {
    ...
    val books : LiveData<List<Book>> = bookRepo.getBooksByStatus(ReadingStatus.Quit)

    val booksCount : LiveData<Int> = bookRepo.getBooksCountByStatus(ReadingStatus.Quit)
